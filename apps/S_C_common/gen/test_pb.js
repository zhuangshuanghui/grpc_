...
$root.test = (function() {
    ...
    test.Test = (function() {
         ...
         * @memberof test.Test
         * @typedef SayTestCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {test.TestRes} [response] TestRes
         */
         ...
         * @memberof test.Test
         * @instance
         * @param {test.ITestReq} request TestReq message or plain object
         * @param {test.Test.SayTestCallback} callback Node-style callback called with the error, if any, and TestRes
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(Test.prototype.sayTest = function sayTest(request, callback) {
            return this.rpcCall(sayTest, $root.test.TestReq, $root.test.TestRes, request, callback);
        }, "name", { value: "SayTest" });
         ...
         * @instance
         * @param {test.ITestReq} request TestReq message or plain object
         * @returns {Promise<test.TestRes>} Promise
         * @variation 2
         */
    ...
    test.TestReq = (function() {
         ...
         */
        TestReq.decode = function decode(reader, length) {
    ...
    test.TestRes = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TestRes.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
