...
$root.PlayerMove = (function() {
     ...
     * @constructor
     * @param {IPlayerMove=} [properties] Properties to set
     */
     ...
     * @static
     * @param {IPlayerMove=} [properties] Properties to set
     * @returns {PlayerMove} PlayerMove instance
     */
     ...
     * @memberof PlayerMove
     * @static
     * @param {IPlayerMove} message PlayerMove message or plain object to encode
     ...
     * @returns {PlayerMove} PlayerMove
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    PlayerMove.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.PlayerMove();
    ...
    PlayerMove.fromObject = function fromObject(object) {
        if (object instanceof $root.PlayerMove)
            return object;
        var message = new $root.PlayerMove();
        if (object.x != null)
     ...
     * @memberof PlayerMove
     * @static
     * @param {PlayerMove} message PlayerMove
    ...
    PlayerMove.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        ...
        return typeUrlPrefix + "/PlayerMove";
    };
