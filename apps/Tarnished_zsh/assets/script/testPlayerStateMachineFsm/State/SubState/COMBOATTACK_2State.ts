 ...
 *  
 */
export default class COMBOATTACK_2State extends State {
    fsm: StateMachine
    constructor(fsm: StateMachine) {
        super(fsm)
        this.fsm = fsm
        this.maskId = 'comboattack_2'
    ...
    animationCallback() {
        ...
        count.value
        if (count.value as number > 2) {
            this.fsm.setParams(PARAMS_NAME_ENUM.COMBOATTACK_3, true)
        } else {
            this.fsm.setParams(PARAMS_NAME_ENUM.IDLE, true)
        }
